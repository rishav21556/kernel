...
int main(){
    ...
    for (int i = 0;i<5;i++){
        if (fork12 == 0  && fork51==0 && fork23==0 && fork34==0){
            printf("-------------------------------------------------------\n");
        ...
        if (fork12 == 0  && fork23==0 && fork45==0 && fork34==0){
            printf("-------------------------------------------------------\n");
        ...
        if (fork34==0 && fork23==0 && fork45==0 && fork51==0){
            printf("-------------------------------------------------------\n");
            pthread_create(&p3,NULL,Philosopher3,&amountOnPlate_3);
            fork34 = 1;
            fork23 = 1;
        ...
        if (fork34==0 && fork45==0 && fork12==0 && fork51==0){
            printf("-------------------------------------------------------\n");
            pthread_create(&p4,NULL,Philosopher4,&amountOnPlate_4);
            fork34 = 1;
            fork45 = 1;
        ...
        if (fork51==0 && fork45==0 && fork12==0 && fork23==0){
            printf("-------------------------------------------------------\n");
            pthread_create(&p5,NULL,Philosopher5,&amountOnPlate_5);
            fork51 = 1;
            fork45 = 1;
